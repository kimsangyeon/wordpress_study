...
/*
 * register_activation_hook 함수는 플러그인이 활성화 될 때 실행될 플러그인 함수를 등록합니다.
 * */
    
function synapeditor_activate() {
    add_action('wp_enqueue_scripts', 'addStaticFile');
    add_shortcode('initSynapEditor', 'initSynapEditor');
    ...
    wp_editor( $content, 'synapEditor');
}
register_activation_hook(__FILE__, 'synapeditor_activate');